    ...
    <div class="footer bg-secondary text-light">
        <div class="row px-5 py-3">
            <div class="col-sm ">
                ...
                <p class="foot-item ml-3">
                    <a href="<?= url ?>user/produk.php/?kategori=sayur">sayur</a><br>
                    <a href="<?= url ?>user/produk.php/?kategori=buah">buah</a><br>
        ...
        <div class="row justify-content-center">
            <div class="text-center border-top w-100 py-3 bg-secondary">
                <span class="text-light ">&copy CopyRight | by ITEAST</span>
            </div>
        </div>
    </div>
</footer>
