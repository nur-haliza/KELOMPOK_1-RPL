...
$(document).ready(function () {
    ...
    Swal.fire(
      ...
      setTimeout(function () {
        window.location.href =
          "http://localhost/iteast/admin/produk.php/";
      }, 3000)
    );
  }
    ...
    Swal.fire(
      {
        ...
        window.location.href =
          "http://localhost/iteast/user/profil.php/";
      }, 2000));
  }
  ...
  $("#btn-transaksi").click(function () {
    $.get(
      "http://localhost/iteast/ajax_search/transaksi.ajax.php/",
      function (data) {
  ...
  function cari(url, keyword) {
    if (keyword == "") {
      ...
      $.get(
        "http://localhost/iteast/ajax_search/" +
          url +
          ".ajax.php/?cari=" +
          keyword,
        function (data) {
